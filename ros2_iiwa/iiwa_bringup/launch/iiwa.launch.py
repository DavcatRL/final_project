...
def generate_launch_description():
    ...
    '''iiwa_world_path= get_package_share_directory('iiwa_description') + 'gazebo/worlds/aruco_world.world'''
    declared_arguments.append(DeclareLaunchArgument('gz_args', default_value='-r -v 1 empty.sdf',
                              description='Arguments for gz_sim'),)
        
    '''declared_arguments.append(DeclareLaunchArgument('gz_args', default_value=f"-r {iiwa_simulation_world} -v 1",
                            description='Arguments for gz_sim'),)'''
